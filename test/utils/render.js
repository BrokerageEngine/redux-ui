 ...
 */
const wrapWithProvider = jsx => <Provider store={store}>{jsx}</Provider>;

const render = jsx => {
  return ReactTestUtils.renderIntoDocument(wrapWithProvider(jsx));
};
...
export { store, wrapWithProvider, render, renderAndFind };
